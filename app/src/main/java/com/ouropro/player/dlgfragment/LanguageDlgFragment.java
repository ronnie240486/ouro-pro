...
public class LanguageDlgFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.btn_ok.setOnClickListener(new View.OnClickListener(this) { // from class: com.ouropro.player.dlgfragment.LanguageDlgFragment$$ExternalSyntheticLambda0
        ...
        this.btn_cancel.setOnClickListener(new View.OnClickListener(this) { // from class: com.ouropro.player.dlgfragment.LanguageDlgFragment$$ExternalSyntheticLambda0
            public final /* synthetic */ LanguageDlgFragment f$0;

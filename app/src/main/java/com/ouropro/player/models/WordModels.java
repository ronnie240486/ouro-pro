...
public class WordModels implements Serializable {
    ...
    public String getIbo_pro_description() {
        ...
        return (str == null || str.isEmpty()) ? "OuroPro doesn't sell playlist or subscriptions." : this.ibo_pro_description;
    }

    public String getIbo_pro_general_player() {
        String str = this.ibo_pro_general_player;
        return (str == null || str.isEmpty()) ? "OuroPro is General Media Player and it doesn't include any content or playlists." : this.ibo_pro_general_player;
    }
    ...
    public String getLive_tv() {
        ...
        return (str == null || str.isEmpty()) ? "TV ao Vivo" : this.live_tv;
    }
    ...
    public String getMovies() {
        ...
        return (str == null || str.isEmpty()) ? "Filmes" : this.movies;
    }
    ...
    public String getScan_code() {
        ...
        return (str == null || str.isEmpty()) ? "Scan QR to add playlist." : this.scan_code;
    }
    ...
    public String getSeries() {
        ...
        return (str == null || str.isEmpty()) ? "Séries" : this.series;
    }

    public String getSettings() {
        String str = this.settings;
        return (str == null || str.isEmpty()) ? "Configurações" : this.settings;
    }
